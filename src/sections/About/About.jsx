  ...
  return (
    <section id="projects" className={styles.container}>
      ...
      <p className={styles.paragraph}>
       ...
       <a className={styles.links} href="https://linkedin.com/in/aidanfwong" target="_blank"> LinkedIn</a> or
        check out my projects on
         <a className={styles.link} href="https://github.com/aidanfwong" target="_blank"> GitHub</a>. 
